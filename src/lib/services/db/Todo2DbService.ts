...
export class Todo2DbService extends BaseCrud("todo2DbService", CC_APPWRITE_TODO_COLLECTION_ID) {

    public findAll = async () => {
        this.loggerService.log("todo2DbService findAll wrapper");
